...
[RegisterCharacter]
public class BigDogCharacter : ModCharacterTemplate<BigDogCardPool, BigDogRelicPool, BigDogPotionPool>
{
    // 角色名称颜色
    public override Color NameColor => new(0.148f, 0.5f, 0.99f);
    // 能量图标轮廓颜色
    public override Color EnergyLabelOutlineColor => new(0.148f, 0.5f, 0.99f);
    // 地图绘制颜色
    public override Color MapDrawingColor => new(0.146f, 0.5f, 0.94f);
